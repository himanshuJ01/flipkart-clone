...
class CustomerRepositoryTest {
	...
	public void givenCustomerShouldReturnObject() {
		Customer c1 = new Customer(201, "Tom Shaw", "tom.shaw@xyz.com", 123456789, "Male", "TTSS@xy");
	...
	public void getAllmustAllCustomers() {
		Customer c3 = new Customer(202, "Tom Shaw", "tom.shaw@xyz.com",  1234567890, "Male", "TTSS@xy"); //user input
		Customer c4 = new Customer(203, "Tomy Shaw", "tom.shaw@xyz.com", 1234567890, "Male", "TTSS@xy"); //user input
        ...
        assertEquals("Tom Shaw" , customerList.get(1).getFullName());
